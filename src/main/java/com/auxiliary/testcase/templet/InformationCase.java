...
public class InformationCase extends Case {
    ...
    private Case basicTextboxCase(String operation, String name, boolean isMust, boolean isRepeat, boolean isClear,
		...
		addFieldText(LabelType.PRECONDITION, getLabelText(caseName, LabelType.PRECONDITION, OPERATION_ADD.equals(operation) ? "2" : "3"));
		//存储关键词信息
		addFieldText(LabelType.KEY, getLabelText(caseName, LabelType.KEY, "1"));
		//存储优先级信息
	 ...
	 * @throws CaseContentException 当限制参数传入有误时抛出
	 */
	public Case editLengthRuleTextboxCase(String name, boolean isMust, boolean isRepeat, boolean isClear, int minLen, int maxLen, InputRuleType... inputRuleTypes) {
	 ...
	 * @throws CaseContentException 当限制参数传入有误时抛出
	 */
	private Case lengthRuleTextboxCase(String operation, String name, boolean isMust, boolean isRepeat, boolean isClear, int minLen, int maxLen, InputRuleType... inputRuleTypes) {
		//清空字段的内容
		clearFieldText();
		// 存储case标签的name属性内容
		String caseName = "addTextboxCase";
		...
		//存储前置条件信息
		addFieldText(LabelType.PRECONDITION, getLabelText(caseName, LabelType.PRECONDITION, "1"));
		addFieldText(LabelType.PRECONDITION, getLabelText(caseName, LabelType.PRECONDITION, "新增".equals(operation) ? "2" : "3"));
		//存储关键词信息
		addFieldText(LabelType.KEY, getLabelText(caseName, LabelType.KEY, "1"));
		//存储优先级信息
		addFieldText(LabelType.RANK, getLabelText(caseName, LabelType.RANK, isMust ? "1" : "2"));
	 ...
	 * @throws CaseContentException 当限制参数传入有误时抛出
	 */
	public Case editNumberRuleTextboxCase(String name, boolean isMust, boolean isRepeat, boolean isClear, int decimals, int minNum, int maxNum) {
	 ...
	 * @throws CaseContentException 当限制参数传入有误时抛出
	 */
	private Case numberRuleTextboxCase(String operation, String name, boolean isMust, boolean isRepeat, boolean isClear, int decimals, int minNum, int maxNum) {
		//清空字段的内容
		clearFieldText();
		// 存储case标签的name属性内容
		String caseName = "addTextboxCase";
	 ...
	 * @return 类本身
	 */
	private Case phoneCase(String operation, String name, boolean isMust, boolean isRepeat, boolean isClear, PhoneType...phoneTypes) {
		//清空字段的内容
		clearFieldText();
		// 存储case标签的name属性内容
	 ...
	 * @return 类本身
	 */
	private Case startDateCase(String operation, String name, String endDateName, boolean isMust, boolean isInput, boolean isClear) {
		//清空字段的内容
		clearFieldText();
		// 存储case标签的name属性内容
		String caseName = "addDateCase";
	 ...
	 * @return 类本身
	 */
	private Case endDateCase(String operation, String name, String startDateName, boolean isMust, boolean isInput, boolean isClear) {
		//清空字段的内容
		clearFieldText();
		// 存储case标签的name属性内容
		String caseName = "addDateCase";
	...
	public Case addUploadFileCase(String name, boolean isMust, boolean isDelete, boolean isPreview, int fileSize, int minLen, int maxLen, UploadFileType uploadFileType, FileRuleType...fileRuleTypes) {
		return uploadFileCase(OPERATION_ADD, name, isMust, isDelete, isPreview, fileSize, minLen, maxLen, uploadFileType, fileRuleTypes);
	}
	 ...
	 * @return 类本身
	 */
	public Case editUploadFileCase(String name, boolean isMust, boolean isDelete, boolean isPreview, int fileSize, int minLen, int maxLen, UploadFileType uploadFileType, FileRuleType...fileRuleTypes) {
		return uploadFileCase(OPERATION_EDIT, name, isMust, isDelete, isPreview, fileSize, minLen, maxLen, uploadFileType, fileRuleTypes);
	}
	 ...
	 * @return 类本身
	 */
	private Case uploadFileCase(String operation, String name, boolean isMust, boolean isDelete, boolean isPreview, int fileSize, int minLen, int maxLen, UploadFileType uploadFileType, FileRuleType...fileRuleTypes) {
		//清空字段的内容
		clearFieldText();
		// 存储case标签的name属性内容
